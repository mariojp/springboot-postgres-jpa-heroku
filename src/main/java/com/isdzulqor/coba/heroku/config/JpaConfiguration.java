package com.isdzulqor.coba.heroku.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.isdzulqor.coba.heroku.repository",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.isdzulqor.coba.heroku.entity" });
